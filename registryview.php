...
$sql = "SELECT * FROM tb_registry";
$result = mysqli_query($conn, $sql);

if ($result->num_rows > 0) {
    echo "<tr><th>Register ID</th><th>Register Name</th><th>Register Contact</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["reg_id"]. "</td><td>" . $row["reg_name"]."</td><td>".$row["reg_contact"]."</td></tr>";
    }
    echo "</table>";
}
else {
