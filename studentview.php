...
<h2 align="center">Student Data Sheet </h2>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["student_id"]. "</td><td>" . $row["student_name"]."</td><td>".$row["student_section"]."</td><td>" . $row["student_group"]."</td><td>".$row["student_contact"]."</td></tr>";
    }
    echo "</table>";
}
else {
