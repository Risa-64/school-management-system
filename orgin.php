...
$aid = $_POST['organization_id'];
$cardnumber = $_POST['organization_name'];
$atmlocation = $_POST['organization_contact'];



$sql = "INSERT INTO tb_organization(org_id,org_name,org_contact) VALUES('$aid', '$cardnumber','$atmlocation')";
